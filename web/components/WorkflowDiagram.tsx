  ...
  return (
    <div className="relative flex w-[156px] flex-col items-center">
      <div className="flex h-[78px] w-[156px] flex-col items-center justify-center rounded-[16px] border border-[#e5e3df] bg-white shadow-[0_4px_16px_rgba(16,17,20,0.06)]">
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#EFF6FF] text-[#0052FF]">{data.icon}</div>
        ...
        {data.done && (
          <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#0052FF] text-white shadow-sm">
