...
export default function SecurityDiagram() {
  return (
    <div className="overflow-hidden rounded-[24px] border border-[#e3dfd7] bg-white p-6 md:p-8">
      <div className="mb-6">
        <p className="text-[11px] font-extrabold tracking-[0.14em] text-[#d94a1e]">B20 COMPLIANCE & GUARDRAILS</p>
        <h3 className="mt-1 font-[var(--font-sora)] text-xl font-semibold tracking-tight text-[#d94a1e]">Strict hooks. No silent failures.</h3>
      ...
      <div className="relative grid grid-cols-1 gap-4 md:grid-cols-[1.1fr_1fr]">
        <div className="rounded-2xl border-2 border-dashed border-[#e3dfd7] bg-[#fcfaf8] p-5">
          ...
          <div className="mt-4 space-y-3">
            <div className="animate-slide-in rounded-xl border border-[#e3dfd7] bg-white p-3 shadow-[0_1px_3px_rgba(0,0,0,0.04)] delay-100">
              ...
              <p className="mt-1 text-[11px] text-[#77736c]">Member → withdraw 0.20 NVDAc to 0x...</p>
            </div>
            <div className="flex justify-center">
              <div className="h-6 w-[2px] bg-[#d94a1e] opacity-60" />
            </div>
            <div className="animate-slide-in rounded-xl border-2 border-[#d94a1e] bg-[#d94a1e] p-3 text-white delay-200">
        ...
        <div className="rounded-2xl border-2 border-dashed border-[#d94a1e]/20 bg-[#EFF6FF]/60 p-5">
          <p className="text-[10px] font-extrabold tracking-widest text-[#d94a1e]">BASE NETWORK ENCLAVES</p>
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="animate-slide-in rounded-xl border border-[#d94a1e]/20 bg-white p-3 delay-300">
              <div className="mb-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-[#EFF6FF] text-[#d94a1e]">
                <ShieldCheck className="h-4 w-4" />
              </div>
              <p className="text-xs font-bold text-[#d94a1e]">Authorized</p>
              <p className="mt-1 text-[11px] leading-relaxed text-[#d94a1e]/70">Transfer Stock</p>
              <p className="mt-1 font-mono text-[10px] text-[#d94a1e]">→ B20 transfer succeeds</p>
            </div>
            <div className="animate-slide-in rounded-xl border border-[#e3dfd7] bg-white p-3 delay-400">
              <div className="mb-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-[#f5f3ee] text-[#d94a1e]">
              ...
              <p className="mt-1 font-mono text-[10px] text-[#d94a1e]">→ Aerodrome swap → USDC</p>
            </div>
            <div className="col-span-2 animate-slide-in rounded-xl border border-[#d94a1e]/20 bg-white p-3 delay-500">
              <div className="flex items-center gap-2">
                <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#EFF6FF] text-[#d94a1e]">
                  <Timer className="h-4 w-4" />
                </div>
                <p className="text-xs font-bold text-[#d94a1e]">Chainlink Oracle Wrapper</p>
                <span className="ml-auto rounded-full bg-[#d94a1e] px-2 py-0.5 text-[10px] font-bold text-white">72hr Weekend Grace</span>
              </div>
